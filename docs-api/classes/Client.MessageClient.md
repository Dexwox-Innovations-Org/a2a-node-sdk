[A2A Node SDK - v0.1.0](../README.md) / [Modules](../modules.md) / [Client](../modules/Client.md) / MessageClient

# Class: MessageClient

[Client](../modules/Client.md).MessageClient
...
- [constructor](Client.MessageClient.md#constructor)

### Properties

- [agents](Client.MessageClient.md#agents)
- [captureRejectionSymbol](Client.MessageClient.md#capturerejectionsymbol)
- [captureRejections](Client.MessageClient.md#capturerejections)
- [defaultMaxListeners](Client.MessageClient.md#defaultmaxlisteners)
- [errorMonitor](Client.MessageClient.md#errormonitor)
- [tasks](Client.MessageClient.md#tasks)

### Methods

- [[captureRejectionSymbol]](Client.MessageClient.md#[capturerejectionsymbol])
- [addAbortListener](Client.MessageClient.md#addabortlistener)
- [addListener](Client.MessageClient.md#addlistener)
- [emit](Client.MessageClient.md#emit)
- [eventNames](Client.MessageClient.md#eventnames)
- [getEventListeners](Client.MessageClient.md#geteventlisteners)
- [getMaxListeners](Client.MessageClient.md#getmaxlisteners)
- [getMaxListeners](Client.MessageClient.md#getmaxlisteners-1)
- [listenerCount](Client.MessageClient.md#listenercount)
- [listenerCount](Client.MessageClient.md#listenercount-1)
- [listeners](Client.MessageClient.md#listeners)
- [off](Client.MessageClient.md#off)
- [on](Client.MessageClient.md#on)
- [on](Client.MessageClient.md#on-1)
- [once](Client.MessageClient.md#once)
- [once](Client.MessageClient.md#once-1)
- [prependListener](Client.MessageClient.md#prependlistener)
- [prependOnceListener](Client.MessageClient.md#prependoncelistener)
- [rawListeners](Client.MessageClient.md#rawlisteners)
- [removeAllListeners](Client.MessageClient.md#removealllisteners)
- [removeListener](Client.MessageClient.md#removelistener)
- [sendMessage](Client.MessageClient.md#sendmessage)
- [setMaxListeners](Client.MessageClient.md#setmaxlisteners)
- [setMaxListeners](Client.MessageClient.md#setmaxlisteners-1)
- [streamMessage](Client.MessageClient.md#streammessage)

## Constructors

### constructor

• **new MessageClient**(`options`): [`MessageClient`](Client.MessageClient.md)
...
[`MessageClient`](Client.MessageClient.md)
...
• `Readonly` **agents**: [`AgentClient`](Client.AgentClient.md)
...
• `Readonly` **tasks**: [`TaskClient`](Client.TaskClient.md)
...
| `agentId` | `string` | ID of the target agent to receive the message |
...
| `agentId` | `string` | ID of the target agent to stream with |
| `options` | [`StreamOptions`](../interfaces/Client.StreamOptions.md) & \{ `backoffFactor?`: `number` ; `heartbeatInterval?`: `number` ; `heartbeatTimeout?`: `number` ; `maxRetries?`: `number` ; `maxRetryDelay?`: `number` ; `retryDelay?`: `number`  } | Configuration options and event handlers for the stream |
