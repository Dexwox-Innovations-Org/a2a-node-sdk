[A2A Node SDK - v0.1.0](../README.md) / [Modules](../modules.md) / [Client](../modules/Client.md) / TaskClient

# Class: TaskClient

[Client](../modules/Client.md).TaskClient
...
• **new TaskClient**(`options`): [`TaskClient`](Client.TaskClient.md)
...
[`TaskClient`](Client.TaskClient.md)
...
▸ **getTaskStatus**(`taskId`): `Promise`\<[`Task`](../interfaces/Core.Task.md)\>
...
▸ **listTasks**(`options?`): `Promise`\<[`Task`](../interfaces/Core.Task.md)[]\>
...
| `callback` | (`task`: [`Task`](../interfaces/Core.Task.md)) => `void` | Function to call when the task is updated |
