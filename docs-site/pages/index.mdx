...
graph TD
    ...
    F["@dexwox/a2a-client"] --> B
    G["@dexwox/a2a-core"] --> F
    G --> H["@dexwox/a2a-server"]
    H --> B
```

## Packages Overview

### Core Package (`@dexwox/a2a-core`)
...
- [Discord Community](https://discord.gg/dexwox)
