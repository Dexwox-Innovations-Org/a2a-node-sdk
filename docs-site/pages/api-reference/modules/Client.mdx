...
[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / Client
...
- [AgentClient](/api-reference/classes/Client.AgentClient)
- [MessageClient](/api-reference/classes/Client.MessageClient)
- [TaskClient](/api-reference/classes/Client.TaskClient)

### Interfaces

- [MessageClientOptions](/api-reference/interfaces/Client.MessageClientOptions)
- [StreamOptions](/api-reference/interfaces/Client.StreamOptions)
