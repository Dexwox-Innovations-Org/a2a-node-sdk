...
[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / [Core](/api-reference/modules/Core) / DiscoverResponse

# Interface: DiscoverResponse

[Core](/api-reference/modules/Core).DiscoverResponse
...
• **result**: [`AgentCard`](Core.AgentCard)[]
