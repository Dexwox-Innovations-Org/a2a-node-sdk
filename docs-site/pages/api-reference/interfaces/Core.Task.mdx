...
[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / [Core](/api-reference/modules/Core) / Task

# Interface: Task

[Core](/api-reference/modules/Core).Task
...
• `Optional` **transitions**: [`TaskTransition`](Core.TaskTransition)[]
