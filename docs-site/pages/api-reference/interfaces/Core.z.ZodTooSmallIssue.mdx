...
[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / [Core](/api-reference/modules/Core) / [z](/api-reference/modules/Core.z) / ZodTooSmallIssue

# Interface: ZodTooSmallIssue

[Core](/api-reference/modules/Core).[z](/api-reference/modules/Core.z).ZodTooSmallIssue
