...
[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / [Client](/api-reference/modules/Client) / MessageClientOptions

# Interface: MessageClientOptions

[Client](/api-reference/modules/Client).MessageClientOptions
