...
[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / [Server](/api-reference/modules/Server) / DefaultRequestHandler

# Class: DefaultRequestHandler

[Server](/api-reference/modules/Server).DefaultRequestHandler
...
- [`RequestHandler`](/api-reference/interfaces/Server.RequestHandler)
...
• **new DefaultRequestHandler**(`agents?`): [`DefaultRequestHandler`](Server.DefaultRequestHandler)
...
| :------ | :------ | :------ | :------ |
| `agents` | [`AgentCard`](/api-reference/interfaces/Core.AgentCard)[] | `[]` | Array of available agent cards |
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[router](../interfaces/Server.RequestHandler.md#router)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleCancelTask](../interfaces/Server.RequestHandler.md#handlecanceltask)
...
▸ **handleDiscoverAgents**(`capability?`): `Promise`\<[`AgentCard`](/api-reference/interfaces/Core.AgentCard)[]\>
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleDiscoverAgents](../interfaces/Server.RequestHandler.md#handlediscoveragents)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleGetPushConfig](../interfaces/Server.RequestHandler.md#handlegetpushconfig)

___

### handleGetTaskStatus

▸ **handleGetTaskStatus**(`taskId`): `Promise`\<[`Task`](/api-reference/interfaces/Core.Task)\>
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleGetTaskStatus](../interfaces/Server.RequestHandler.md#handlegettaskstatus)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleSendMessage](../interfaces/Server.RequestHandler.md#handlesendmessage)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleSetPushConfig](../interfaces/Server.RequestHandler.md#handlesetpushconfig)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleStreamMessage](../interfaces/Server.RequestHandler.md#handlestreammessage)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[handleTaskResubscription](../interfaces/Server.RequestHandler.md#handletaskresubscription)
...
▸ **normalizeError**(`err`): [`A2AError`](Core.A2AError)
...
[RequestHandler](/api-reference/interfaces/Server.RequestHandler).[normalizeError](../interfaces/Server.RequestHandler.md#normalizeerror)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `schema` | [`ZodType`](Core.z.ZodType)\<`any`, [`ZodTypeDef`](/api-reference/interfaces/Core.z.ZodTypeDef), `any`\> | Zod schema to validate against |
