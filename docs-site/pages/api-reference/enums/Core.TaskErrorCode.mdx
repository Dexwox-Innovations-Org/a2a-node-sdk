...
---
title: Core. Task Error Code
---

[A2A Node SDK - v0.1.0](/api-reference/README) / [Modules](/api-reference/modules) / [Core](/api-reference/modules/Core) / TaskErrorCode

# Enumeration: TaskErrorCode

[Core](/api-reference/modules/Core).TaskErrorCode
