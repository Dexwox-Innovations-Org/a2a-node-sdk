...
The `@dexwox/a2a-core` package provides the foundational types, utilities, and protocol definitions for the A2A Node SDK.
...
```typescript
import { AgentCardSchema, TaskSchema, MessageSchema } from '@dexwox/a2a-core';
...
```typescript
import { createTextMessage, createFileMessage, createDataMessage } from '@dexwox/a2a-core';
...
```typescript
import { createTask, updateTaskStatus, isTaskComplete } from '@dexwox/a2a-core';
...
```typescript
import { validateAgentCard, validateTask, validateMessage } from '@dexwox/a2a-core';
...
```typescript
import { z } from 'zod';
import { AgentCardSchema } from '@dexwox/a2a-core';
